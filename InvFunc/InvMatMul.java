public class InvMatMul {

   public static void main(String[] args) {
   
      String[][] mat1 = {{"1","1"},{"1","2"}},mat2 = {{"A","6"},{"1","C"}}; 
       
      String[][] mat3 = {{"1","1"},{"1","9"}},mat4 = {{"B","A"},{"8","D"}};
     ...
     //  printMatrix(multiply(mat3,mat4));  
      ...
      for(int i = 0; i < varg.length; i++) {
         ...
         for(int j = 0; j < varg.length; j++) {     
            ...
            if(add(multiply(varg[i],"B"),multiply(varg[j],"8")).equals("A") && add(multiply(varg[i],"A"),multiply(varg[j],"D")).equals("6")) {
            
               System.out.println(varg[i] + " " + varg[j]);
            }
      ...
      for(int i = 0; i < varg.length; i++) {
         ...
         for(int j = 0; j < varg.length; j++) {     
            ...
            if(add(multiply(varg[i],"B"),multiply(varg[j],"8")).equals("1") && add(multiply(varg[i],"A"),multiply(varg[j],"D")).equals("C")) {
      ...
      for(int i = 0; i < varg.length; i++) {
         ...
         for(int j = 0; j < varg.length; j++) {     
            ...
            if(add(multiply(varg[i],"2"),multiply(varg[j],"1")).equals("3") && add(multiply(varg[i],"5"),multiply(varg[j],"8")).equals("F")) {
      ...
      for(int i = 0; i < varg.length; i++) {
         ...
         for(int j = 0; j < varg.length; j++) {     
            ...
            if(add(multiply(varg[i],"2"),multiply(varg[j],"1")).equals("1") && add(multiply(varg[i],"5"),multiply(varg[j],"8")).equals("A")) {
