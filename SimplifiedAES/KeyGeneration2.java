...
public class KeyGeneration2 {
   ...
   public static void main(String[] args) {
      ...
      String[] K0 = {"1100","1111","1010","0001"};
   
      String[] K1 = round2(K0,1); 
        
      String[] K2 = round2(K1,2);
     
      String[] K3 = round2(K2,3);  
   ...
   public static String[] round2(String[] keyI,int k) {
      ...
      boolean[] gFk3N = binaryToBoolean(gFunction2(booleanToBinary(k3N),k));
   ...
   public static String gFunction2(String binary,int k) {
