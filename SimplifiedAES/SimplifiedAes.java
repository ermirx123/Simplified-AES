public class SimplifiedAes {
   ...
   public static String[][] EnryptAes(String[][] P,String[][] K) {
     ...
     // String[] K1_start = {"1011","0101","1101","1111"};
      
      String[] keyGen1 = keyGen.round(K1_start);
      String[][] keyGen1Mat = oneToTwoDimArray(keyGen1);  
      
                
      String[][] addRoundKey = addXorMatrix(afterMixedCol,keyGen1Mat);
   	// End of Round 1
      
      // Round 2     
      String[][] sBoxOperations2 = sBoxOperations(binaryAfterMixedCol);
      ...
      String[] keyGen2 = keyGen.round(keyGen1);     
      String[][] keyGen2Mat = oneToTwoDimArray(keyGen2); 
      String[][] addRoundKey2 = addXorMatrix(afterMixedCol2,keyGen2Mat);
      // End of Round 2
      
      // Round 3
      String[][] sBoxOperations3 = sBoxOperations(binaryAfterMixedCol2);
      
      String[][] afterMixedCol3 = MixColumns.multiply(mat, sBoxOperations3);
      String[][] binaryAfterMixedCol3 = hexToBinaryMatrix(afterMixedCol3);
   	
      String[] keyGen3 = keyGen.round(keyGen2);     
      String[][] keyGen3Mat = oneToTwoDimArray(keyGen3); 
      String[][] addRoundKey3 = addXorMatrix(afterMixedCol3,keyGen3Mat); 
      // End of Round 3
